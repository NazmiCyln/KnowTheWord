...
public class ShopAdapter extends RecyclerView.Adapter<ShopAdapter.ShopHolder> {
    ...
    class ShopHolder extends RecyclerView.ViewHolder{
        ...
        public ShopHolder(@NonNull View itemView) {
            ...
            btnItemPrice = (Button)itemView.findViewById(R.id.custom_dialog_shop_item_buttonItemPrice);
            ...
            btnItemPrice.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    //gerekli şartları şağlıyorsa pozisyonu ekle
    ...
    //tıklananan butonun pozisyonuna alıp ona göre işlem yapılacak
